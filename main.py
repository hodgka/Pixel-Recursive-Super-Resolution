...
parser.add_argument('--batch_size', default=32, type=int, help='Number of images per minibatch')
parser.add_argument('--image_size', default=32, type=int, help='Size of high resolution image')
parser.add_argument('--epochs', default=20000, type=float, help='Number of epochs to train for')
